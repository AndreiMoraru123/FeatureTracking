...
#include "dataStructure.h" // you do not need to look into this file
                      ...
                      std::vector<cv::DMatch> kptMatches, double frameRate, double &TTC)
{
    ...
    { // outer keypoint loop
        ...
        // clear the vector of distance ratios
        distRatios.clear();
...
int main()
{
    ...
    readKeypoints(R"(D:\CameraVision\TTC-camera\dat\C23A5_KptsSource_SHI-BRISK.dat)",
                  kptsSource); // readKeypoints("./dat/C23A5_KptsSource_SHI-BRISK.dat"
    readKeypoints(R"(D:\CameraVision\TTC-camera\dat\C23A5_KptsRef_SHI-BRISK.dat)",
                  kptsRef); // readKeypoints("./dat/C23A5_KptsRef_SHI-BRISK.dat"

    // step 2: read pre-recorded keypoint matches from file
    vector<cv::DMatch> matches;
    readKptMatches(R"(D:\CameraVision\TTC-camera\dat\C23A5_KptMatches_SHI-BRISK.dat)",
