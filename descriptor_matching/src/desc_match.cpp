...
int main()
{
    cv::Mat imgSource = cv::imread(R"(D:\CameraVision\IntensityGradientAndFiltering\gradient_filtering\images\img1gray.png)");
    cv::Mat imgRef = cv::imread(R"(D:\CameraVision\IntensityGradientAndFiltering\gradient_filtering\images\img2gray.png)");

    vector<cv::KeyPoint> kPtsSource, kPtsRef;
    readKeypoints(R"(D:\CameraVision\descriptor_matching\dat\C35A5_KptsSource_BRISK_large)", kPtsSource);
    readKeypoints(R"(D:\CameraVision\descriptor_matching\dat\C35A5_KptsRef_BRISK_large)", kPtsRef);

    cv::Mat descSource, descRef;
    readDescriptors(R"(D:\CameraVision\descriptor_matching\dat\C35A5_DescSource_BRISK_large)", descSource);
    readDescriptors(R"(D:\CameraVision\descriptor_matching\dat\C35A5_DescRef_BRISK_large)", descRef);
